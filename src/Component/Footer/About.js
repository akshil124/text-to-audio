  ...
  return(<><div className='mainContainers'><div className='card'>
    <section className="about-section">
      <div className="about-container">
        <h1>About Us</h1>
        <p>Welcome to DarkSite, where the depths of design meet the elegance of darkness. Our team is composed of
          creative minds who are passionate about crafting unique and immersive web experiences that embrace the dark
          aesthetic.</p>
        <p>With a focus on innovation and attention to detail, we strive to create websites that not only look stunning
          but also provide exceptional functionality and user experience.</p>
        <p>At DarkSite, we believe that darkness can evoke emotions, create moods, and captivate audiences in ways that
