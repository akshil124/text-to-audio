  ...
  return(<>
    ...
    <div className='inside-article'>
      <header className="entry-header" aria-label="Content">
        <h1 className="entry-title" itemProp="headline">Privacy Policy</h1></header>
    <div className="entry-content" itemProp="text">

      <h2 className="wp-block-heading">Who we are</h2>


      <p>Our website address is: https://text-to-audio-indol.vercel.app/.</p>
      ...
      <p>An anonymised string created from your email address (also called a hash) may be provided to the Gravatar
      ...
      <p>When you log in, we will also set up several cookies to save your login information and your screen display
        ...
        Me”, your login will persist for two weeks. If you log out of your account, the login cookies will be
        removed.</p>
      ...
      <p>If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognise and
      ...
      <p><strong>Feel free to ask your queries: help@dragganaitool.com</strong></p>
    </div></div>
