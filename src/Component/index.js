    ...
    return (<div className="modal">
      <div className="modal-content">
        <span className="close-btn" onClick={() => {
          setOpen({show: !open.show, voiceId: null, name: null});
          setFile("");
          setText('')
        }}>&times;</span>
        ...
        {(text && file) ? <div className='audio-container'>
            <audio controls id='audioSource' src={file} controlsList="nodownload noplaybackrate "/>
        ...
        <motion.div initial={{y: -100}}
          ...
          <div className="container">
            ...
            <div className="InputContainer">
              <input placeholder="Search for your Voices Card" onChange={(e) => {
          ...
          if (search) {
            ...
            <motion.div
              ...
              <div className="card-front" key={index}>
                <div onClick={() => setOpen({show: !open.show, voiceId: ele?.voice_id, name: ele?.name})}><h2
                  className="name">{ele?.name}</h2>
                  <div className="user-profile">
                    <img src={ele.labels.gender === "male" ? mAvatar : fAvatar} alt="Profile Picture"/>
                  </div>
                  <div className='subDetail'><p className="category">Category: {ele.category}</p><p
                    className="labels">Accent: {ele?.labels.accent}</p></div>
                </div>
                <div className={`audio-player ${ele.name}`}>
